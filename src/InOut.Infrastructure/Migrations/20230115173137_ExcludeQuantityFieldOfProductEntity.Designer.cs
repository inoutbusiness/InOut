...
namespace InOut.Infrastructure.Migrations
{
    ...
    [Migration("20230115173137_ExcludeQuantityFieldOfProductEntity")]
    partial class ExcludeQuantityFieldOfProductEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InOut.Domain.Entities.Brand", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIGINT");
            ...
            modelBuilder.Entity("InOut.Domain.Entities.Product", b =>
                {
                    b.HasOne("InOut.Domain.Entities.Brand", "Brand")
                        .WithMany("Products")
